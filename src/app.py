...
activities = {
    ...
    "Basketball Team": {
        "description": "Indoor team basketball practices and games against other schools",
    ...
    "Choir": {
        "description": "Vocal ensemble rehearsals and performances for singers of all levels",
